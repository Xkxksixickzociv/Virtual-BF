...
function onCreate()
   ...
   makeLuaSprite('bf', 'VirtualPet/BFpet', 430, 200)
   ...
   makeAnimatedLuaSprite('bfEyes', 'VirtualPet/eyes', 430, 200)
   addAnimationByPrefix('bfEyes', 'normal', 'Normal', 1, true)
   addAnimationByPrefix('bfEyes', 'blink', 'Blink', 32, false) 
   ...
   makeAnimatedLuaSprite('bfMouth', 'VirtualPet/mouth', 430, 200)
   ...
   makeAnimatedLuaSprite('bfExpression', 'VirtualPet/emotions', 430, 200)
